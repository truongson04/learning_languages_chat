...
export default function NotificationPage() {
  const { isLoading, isPending, acceptRequestMutation, friendRequests } =
    useNotification();
  const incomingRequests = friendRequests?.request || [];
  const acceptedRequests = friendRequests?.accept || [];
  return (
